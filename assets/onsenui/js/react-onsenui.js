...
Navigator.propTypes = {
   ...
   *  [ja][/ja]
   */
  swipeable: React.PropTypes.oneOfType([React.PropTypes.bool, React.PropTypes.string]),
...
Modal.propTypes = {
   ...
   *   [/en]
   */
  animation: React.PropTypes.oneOf(['none', 'fade', 'lift']),
...
Page.propTypes = {
   ...
   *  [ja][/ja]
   */
  onInfiniteScroll: React.PropTypes.func,
...
RouterNavigator.propTypes = {
   ...
   *  [ja][/ja]
   */
  routeConfig: React.PropTypes.shape({
    routeStack: React.PropTypes.arrayOf(React.PropTypes.object),
    processStack: React.PropTypes.arrayOf(React.PropTypes.object)
  }),
...
Segment.propTypes = {
   ...
   *  [ja][/ja]
   */
  tabbarId: React.PropTypes.string,
...
Tabbar.propTypes = {
   ...
   *  [ja][/ja]
   */
  ignoreEdgeWidth: React.PropTypes.bool,
   ...
   *  [ja][/ja]
   */
  animation: React.PropTypes.oneOf(['none', 'slide']),
   ...
   *  [ja][/ja]
   */
  tabBorder: React.PropTypes.bool,
